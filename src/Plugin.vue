    ...
    <div class="integration" :style="cssVars">
        <div v-if="!modalIsOpen">
            ...
            >
                ...
                <option
                    v-if="isEnabledSelection('categories')"
                    value="categories"
                >
                    Categories
                </option>
                <option v-if="isEnabledSelection('pages')" value="pages">
                    Pages
                </option>
        ...
        pluginCreated() {
            ...
            switch (this.spaceId) {
                ...
                case 171815:
                    configWithOptions = {
                        magentoUrl:
                            "https://test-admin.tafelzeilonline.com/graphql",
                        productsLimit: "1",
                        contentTypes: "page",
                        selectionOptions: "products, categories, pages, link",
                        primaryColor: "#ef8177",
            ...
            if (configWithOptions) {
                configWithOptions = Object.assign(
                    {},
                    configWithOptions,
                    this.options
                );
                const optionsArr =
                    configWithOptions.selectionOptions.split(",");
